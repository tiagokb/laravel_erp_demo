...
<head>
    ...
    <title>{{ $title ?? 'Montink Test ERP' }}</title>
...
<body class="relative top-0 left-0 inset-0">
<div class="bg-black/90 text-white flex flex-col justify-between min-h-screen">
    <header class="p-4 bg-black/30">
        <nav class="flex justify-center gap-4 px-8">
            <a
    ...
    <footer class="flex justify-center text-sm">
        <a href="https://github.com/tiagokb" target="_blank">Desenvolvido por Tiago Kontarski Barbosa</a>
    </footer>
</div>
@stack('scripts')
</body>
